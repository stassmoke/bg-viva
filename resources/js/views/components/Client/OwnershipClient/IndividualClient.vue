<template>
    <div>
        <v-row class="justify-center">
            ...
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.registration_address"
                              label="Адреса прописки"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.residence_address"
                              label="Адреса проживання"></v-text-field>
            </v-col>
        </v-row>

        <v-row>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.contact_phone" type="number"
                              label="Контактний телефон"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.work_place"
                              label="Місце роботи"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.work_place_phone" type="number"
                              label="Телефон з місця роботи"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.average_monthly_income"
                              label="Середньомісячний дохід"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="input-centered" v-model="individual.another_income"
                              label="Інші доходи"></v-text-field>
            </v-col>
        </v-row>
